...
static void rebalance(RedBlackTree* RBT, RedBlackTreeNode* node);
...
static RedBlackTreeNode* node_rotate_left(RedBlackTreeNode* node, RedBlackTreeNode* node_right)
{
